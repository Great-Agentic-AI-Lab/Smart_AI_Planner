...
MERGED VERSION: Includes Perplexity fallback + all original settings
"""
...
class Settings(BaseSettings):
    ...
    # Google Gemini (Primary LLM) - FREE VERSION
    google_api_key: Optional[str] = Field(default=None, alias="GOOGLE_API_KEY")
    google_model: str = Field(default="gemini-flash-latest", alias="GOOGLE_MODEL")  # Free tier

    # Perplexity (Fallback LLM) - NEW!
